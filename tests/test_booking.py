...
def test_booking_constructs():
    booking = Booking(1, 2, 3, 4, "pending", "2023-07-18")
    assert booking.id == 1
...
def test_equal_booking_objects():
    booking1 = Booking(1, 2, 3, 4, "pending", "2023-07-18")
    booking2 = Booking(1, 2, 3, 4, "pending", "2023-07-18")
...
def test_booking_formats_correctly():
    booking = Booking(1, 2, 3, 4, "pending", "2023-07-18")
    assert str(booking) == "Booking(1, 2, 3, 4, pending, 2023-07-18)"